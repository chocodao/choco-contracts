...
contract Wraper is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Wraper", "WRPR", 9) ERC20Permit() {
    ...
    /**
        @notice increases Wraper supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Wraper
